...
public class TeamMember
{
   ...
   */
   ...
   public static void main(String [] args)
   {
     ...
     Date t4Date = new Date("02/29/2019");
     Date t5Date = new Date("02/28/2019");
     TeamMember t1 = new TeamMember("John",t1Date); //check constructor
     TeamMember t2 = new TeamMember("Wick",t2Date);
     TeamMember t3 = new TeamMember("John",t3Date);
     TeamMember t4 = new TeamMember("John",t4Date);
     TeamMember t5 = new TeamMember("Wick",t5Date);
     System.out.println("Test 1: " + t1.toString() + "\nTest 2: " +
      t2.toString() + "\nTest 3: " + t3.toString() + "\nTest 4: " +
      t4.toString() + "\nTest 5: " + t5.toString()); //Check if toString() works
     ...
     if(t1.equals(t4)){//test equals() in case where name is the same, not date
       System.out.println(t1.toString() + " and " + t4.toString() + " are the same.");
     }else{
       System.out.println(t1.toString() + " and " + t4.toString() + " are not the same.");
     }
     if(t1.equals(t5)){//test equals() in case where name is different, date is the same
       System.out.println(t1.toString() + " and " + t5.toString() + " are the same.");
     }else{
       System.out.println(t1.toString() + " and " + t5.toString() + " are not the same.");
     }
     String notATeamMember = "John 02/28/2019";
     if(t1.equals(notATeamMember)){ //test equals() in case when object is not a TeamMember object
     ...
     System.out.println(t2.name + "'s start date: " + t2.getStartDate());//test getStartDate()
